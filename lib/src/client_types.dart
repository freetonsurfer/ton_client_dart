...
CryptoConfig.fromMap(Map<String,dynamic> map){if (map.containsKey('mnemonic_dictionary')&&(map['mnemonic_dictionary']!=null)) {_mnemonic_dictionary = map['mnemonic_dictionary'];}
...
if (el != null) {_dependencies.add(BuildInfoDependency.fromMap(el));}else {_dependencies.add(null);}}}else{throw('Wrong map data');}
}
