...
if (el != null) {_sending_endpoints.add(el);}else {_sending_endpoints.add(null);}}}else{throw('Wrong map data');}
}
...
List<String> _sending_endpoints;
List<String> get sending_endpoints => _sending_endpoints;
ParamsOfWaitForTransaction({ Abi abi,@required String message,@required String shard_block_id,@required bool send_events, List<String> sending_endpoints,}){
...
if (map.containsKey('sending_endpoints')&&(map['sending_endpoints']!=null)) {_sending_endpoints = [];
for (var el in map['sending_endpoints']) {
if (el != null) {_sending_endpoints.add(el);}else {_sending_endpoints.add(null);}}}
}
